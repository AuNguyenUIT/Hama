...
public class ProductController {
    ...
    public String addProduct(Model model, HttpServletRequest request, @RequestParam("thumb") MultipartFile thumb, @RequestParam("multiple_image") MultipartFile[] multipartFiles) {
        ...
        if (cate_id != null) {
            CategoryEntity category = categoryService.getCategoryById(Integer.parseInt(cate_id));
        ...
        if (!images.isEmpty()) {
            for (MultipartFile image : multipartFiles) {
                try {
                    File folderUpload = new File(request.getServletContext().getRealPath("resources/upload/product/" + productSave.getId()));
    ...
    public String showFormEdit(Model model, HttpServletRequest request) {
        ...
        List<CategoryEntity> categoryList = categoryService.getAll();
        ProductEntity productEntity = productService.getProductById(Integer.parseInt(id));
        model.addAttribute("categoryList", categoryList);
