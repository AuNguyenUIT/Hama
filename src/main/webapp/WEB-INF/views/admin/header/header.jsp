        ...
        <nav class="navbar navbar-expand fixed-top">
            ...
            <ul class="navbar-nav align-items-center right-nav-link">
              ...
              <span class="user-profile"><img
                      src="${pageContext.request.contextPath}/resources/admin/assets/images/images/logo.png"
                      class="img-circle"
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="javaScript:void();">
                                <div class="media">
                                    <div class="avatar"><img class="align-self-start mr-3"
                                                             src="${pageContext.request.contextPath}/resources/admin/assets/images/avatar-admin.png"
                                                             alt="user avatar"></div>
                                    <div class="media-body">
                                        <h6 class="mt-2 user-title">Hama</h6>
                                        <b> Admin:  <%=session.getAttribute("username") %>
                                        </b>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="dropdown-item"><i class="icon-power mr-2"></i><a
                                href="${pageContext.request.contextPath}/dang-xuat"> Đăng xuất</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
