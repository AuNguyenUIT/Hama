                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="aa-footer-widget">
                                    <div class="aa-footer-widget">
                                        ...
                                        <ul class="aa-footer-nav">
                                            <li><a href="${pageContext.request.contextPath}/huong-dan-dat-hang">Hướng
                                                dẫn đặt hàng</a></li>
                                            <li><a href="${pageContext.request.contextPath}/huong-dan-thanh-toan">Hướng
                                                dẫn thanh toán</a></li>
                                            <li><a href="${pageContext.request.contextPath}/chinh-sach-bao-mat">Chính
