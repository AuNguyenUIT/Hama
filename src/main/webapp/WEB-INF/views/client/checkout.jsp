                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="aa-checkout-single-bill">
                                                                    <textarea cols="8" rows="3" required="required"
                                                                              placeholder="Địa chỉ*"
                                                                              name="transaction_address"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                ...
                                <div class="checkout-right">
                                    ...
                                    <div class="aa-payment-method">
                                        ...
                                        <label for="paypal"><input type="radio" id="paypal" name="transaction_payment"
                                                                   value="1"> Thanh toán bằng thể ngân hàng (ATM)
                                        </label>
                                        <img src="${pageContext.request.contextPath}/resources/client/assets/img/paypal.jpg"
